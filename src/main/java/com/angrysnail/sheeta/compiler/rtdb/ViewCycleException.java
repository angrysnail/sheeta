...
public class ViewCycleException extends Exception {
	 ...
	 * 
	 * @param fileName
	 *            the name of the file containing the wrong "view" attribute
	 * @param insertedFileName
	 *            the name of the file that is inserted in the first file
	 */
	public ViewCycleException(String fileName, String insertedFileName) {
		...
		super("A cycle has been found in the view hierarchy :\nin the \""
				...
				+ "of the view attribute to the file \"" + insertedFileName
				+ "\" is wrong");
	}
}
