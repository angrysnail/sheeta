...
public class CompiledColorsBlinkingsFile extends CompiledFile {
	 ...
	 * @param oldIdsToNewIds
	 *            the map associating an old id to a new id of the colors and
	 *            blinkings
	 */
	public CompiledColorsBlinkingsFile(FileManager fileManager, String path,
			Document doc, HashMap<String, String> oldIdsToNewIds) {
