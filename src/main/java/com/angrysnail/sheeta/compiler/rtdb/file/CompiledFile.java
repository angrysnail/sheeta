...
public class CompiledFile {
	 ...
	 *            the type of the file (XML_FILE or SVG_FILE)
	 */
	public CompiledFile(FileManager fileManager, String path, Document doc,
			int type) {
	...
	protected void writeFile() {
		...
		if (doc != null && file != null) {
			...
			try {
				 ...
				 * 
				 * //compressing the svg content GZIPOutputStream zout=new
				 * GZIPOutputStream(out);
				 * 
				 * zout.write(byteBuffer.array()); zout.flush(); zout.close();
				 * 
				 * }else{
				 */
	 ...
	 *            the string buffer
	 * @param returnToLine
	 *            whether each written node should be on a single line
	 */
	public static void writeNode(Node node, StringBuffer buffer,
			boolean returnToLine) {
