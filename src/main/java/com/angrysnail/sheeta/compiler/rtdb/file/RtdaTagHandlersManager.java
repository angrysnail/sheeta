...
public class RtdaTagHandlersManager {
	 ...
	 */
	private Map<String, RtdaTagHandler> jwidgetTagHandlers = new HashMap<String, RtdaTagHandler>();
	...
	protected void loadJWidgetTagHandlers() {
		...
		// getting the map aassociating the id of a jwidget to its description
		// document
		JWidgetRuntimeManager.loadAllJWidgetXMLDescriptions();
		Map<String, Document> jwidgetDocumentsMap = JWidgetRuntimeManager
				.getJWidgetDocumentsMap();
