...
public class StateButtonSimpleSendCommand extends AbstractSimpleSendCommand {
	 ...
	 * the string names
	 */
	protected static String valueDownName = "valueDown",
			valueUpName = "valueUp";
	 ...
	 *            jwidget
	 */
	public StateButtonSimpleSendCommand(SVGPicture picture, String projectName,
	...
	public Runnable dataChanged(DataEvent evt) {
		...
		if (isEntitled()) {
			...
			if (isAuthorized
					&& evt.getDataNameToValue().containsKey(tagToWrite)) {
				...
				String tagDownValue = AnimationsToolkit
						.normalizeEnumeratedValue(actionElement
								.getAttribute(valueDownName));
	...
	public void performAction(Object evt) {
		...
		if (isEntitled() && isAuthorized && showConfirmationDialog()) {
			...
			String theDownValue = AnimationsToolkit
					.normalizeEnumeratedValue(actionElement
							.getAttribute(valueDownName));
			String theUpValue = AnimationsToolkit
					.normalizeEnumeratedValue(actionElement
							.getAttribute(valueUpName));
