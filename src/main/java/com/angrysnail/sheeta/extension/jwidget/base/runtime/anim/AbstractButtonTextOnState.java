 ...
 */
package com.angrysnail.sheeta.extension.jwidget.base.runtime.anim;
...
/**
 * the animation used to modify the text on a button according to an enumerated
 * tag value
 * 
...
public class AbstractButtonTextOnState extends JWidgetAnimation {
	...
	private final static String tagAtt = "tag", invalidTextAtt = "invalidText",
			defaultTextAtt = "defaultText", textAtt = "text", usedAtt = "used",
			valueAtt = "value";

	/**
	 * the map of the text labels associating a possible value of a tag to its
	 * corresponding label
	 */
