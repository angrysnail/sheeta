...
public class ComboLoadView extends AbstractLoadView {
	 ...
	 *            jwidget
	 */
	public ComboLoadView(SVGPicture picture, String projectName,
			...
			for (Node child = actionElement.getFirstChild(); child != null; child = child
				...
				if (child instanceof Element) {
					...
					if (childElement.getAttribute(usedAttName).equals(
						...
						viewPaths.add(childElement
								.getAttribute(viewAttributeName));
					}
				}
			}
		}

		// filling the combo box with the combo items corresponding to each view
		// path
