...
import com.angrysnail.sheeta.extension.jwidget.externaldatatable.edition.ExternalDataTableEdition;
import com.angrysnail.sheeta.extension.jwidget.externaldatatable.runtime.anim.ExternalDataTableLoadData;
	...
	public JWidgetAnimation createAnimation(Element animationElement) {
		...
		if (animationElement != null) {
			...
			if (tagName.equals("rtda:loadData")) {
				...
				animation = new ExternalDataTableLoadData(this, component,
						animationElement);
			}
		}
