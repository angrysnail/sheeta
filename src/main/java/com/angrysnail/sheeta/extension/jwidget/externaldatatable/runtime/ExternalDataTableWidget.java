package com.angrysnail.sheeta.extension.jwidget.externaldatatable.runtime;
...
public class ExternalDataTableWidget extends JPanel {
	 ...
	 * 
	 * @param externalDataTableRuntime
	 *            the external data table runtime
	 * @param element
	 *            the svg element defining the jwidget
	 */
	public ExternalDataTableWidget(
			final ExternalDataTableRuntime externalDataTableRuntime,
			Element element) {
		...
		boolean showRefreshButton = element.getAttribute("showReloadButton")
				.equals(Boolean.toString(true));
		...
		if (showRefreshButton) {
			...
			JWidgetToolkit.handleLook(element, new String[]{
					"reloadButtonForegroundColor", "reloadButtonFontFamily",
					"reloadButtonFontSize", "reloadButtonBold",
					"reloadButtonItalic"}, reloadButton);// TODO
