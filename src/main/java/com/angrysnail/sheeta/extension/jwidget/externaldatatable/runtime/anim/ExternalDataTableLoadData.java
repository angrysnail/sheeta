package com.angrysnail.sheeta.extension.jwidget.externaldatatable.runtime.anim;
...
import com.angrysnail.sheeta.extension.jwidget.externaldatatable.runtime.ExternalDataTableDataBaseAccess;
...
public class ExternalDataTableLoadData extends JWidgetAnimation {
	...
	public ExternalDataTableLoadData(JWidgetRuntime jwidgetRuntime,
		...
		// getting all the children of the animation element and filling the map
		// of the labels
		NodeList labelChildren = animationElement
				.getElementsByTagName(childrenTagName);
