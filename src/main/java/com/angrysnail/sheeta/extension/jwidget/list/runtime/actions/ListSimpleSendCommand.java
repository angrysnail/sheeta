package com.angrysnail.sheeta.extension.jwidget.list.runtime.actions;
...
public class ListSimpleSendCommand extends AbstractSimpleSendCommand {
	 ...
	 *            jwidget
	 */
	public ListSimpleSendCommand(SVGPicture picture, String projectName,
	...
	protected void initializeAction() {
		...
		// filling the list with the items corresponding to each tag to write
		// value
	...
	public void performAction(Object evt) {
		...
		if (isEntitled() && isAuthorized && showConfirmationDialog()) {
			...
			String tagValue = "";
			ComboListItem item = (ComboListItem) ((JList) component)
					.getSelectedValue();
