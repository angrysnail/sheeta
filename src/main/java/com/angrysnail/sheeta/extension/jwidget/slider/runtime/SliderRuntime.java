package com.angrysnail.sheeta.extension.jwidget.slider.runtime;
...
import com.angrysnail.sheeta.extension.jwidget.slider.edition.SliderEdition;
import com.angrysnail.sheeta.extension.jwidget.slider.runtime.actions.SliderSendMeasure;
...
public class SliderRuntime extends JWidgetRuntime {
	...
	public void initialize() {
		...
		try {
			...
			initialValue = Integer.parseInt(element
					.getAttribute("initialValue"));
			minorTickSpacing = Integer.parseInt(element
					.getAttribute("minorTickSpacing"));
			majorTickSpacing = Integer.parseInt(element
					.getAttribute("majorTickSpacing"));
		} catch (Exception ex) {
		}
		...
		inverted = element.getAttribute("inverted").equals(
				Boolean.toString(true)) ? true : false;
		paintTicks = element.getAttribute("paintTicks").equals(
				Boolean.toString(true)) ? true : false;
		paintLabels = element.getAttribute("paintLabels").equals(
				Boolean.toString(true)) ? true : false;

		JSlider slider = new JSlider(orientation, minValue, maxValue,
				initialValue);
