...
import com.angrysnail.sheeta.extension.jwidget.trends.edition.display.DisplayConfigPanel;
import com.angrysnail.sheeta.extension.jwidget.trends.edition.general.GeneralConfigPanel;
...
public class TrendsConfigurationPanel extends JWidgetConfigurationPanel {
	...
	/**
	 * the tabbed pane used for switching from the general configuration pane to
	 * the
	 */
	...
	public void buildPanel() {
		...
		generalConfigPanelWrapper.setLayout(new FlowLayout(FlowLayout.LEFT, 0,
				0));
		...
		displayConfigPanelWrapper.setLayout(new FlowLayout(FlowLayout.LEFT, 0,
				0));
		...
		setLayout(layout);
		layout.putConstraint(SpringLayout.NORTH, this, 0, SpringLayout.NORTH,
				tabbedPane);
		layout.putConstraint(SpringLayout.SOUTH, this, 0, SpringLayout.SOUTH,
				tabbedPane);
		layout.putConstraint(SpringLayout.WEST, this, 0, SpringLayout.WEST,
				tabbedPane);
