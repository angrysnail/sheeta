...
public class VerticalGridLinesDivisionsPanel extends JPanel {
	...
	public void initialize(Element element) {
		...
		durationTimeChooser.init(jwidgetEdition.getProperty(element,
				jwidgetEdition.getPropertiesList().get(14)));
		...
		lineStyleChooser.init(jwidgetEdition.getProperty(element,
				jwidgetEdition.getPropertiesList().get(16)));
	...
	protected void build() {
		...
		try {
			gridVerticalLinesDivisionsLabel = jwidgetEdition.getBundle()
					.getString("gridVerticalLinesDivisions");
			gridVerticalLinesDivisionsAutomaticPeriodLabel = jwidgetEdition
					.getBundle().getString(
							"gridVerticalLinesDivisionsAutomaticPeriod");
			gridVerticalLinesDivisionsDurationLabel = jwidgetEdition
					.getBundle()
					.getString("gridVerticalLinesDivisionsDuration");
			gridVerticalLinesDivisionsColorLabel = jwidgetEdition.getBundle()
					.getString("gridVerticalLinesDivisionsColor");
			gridVerticalLinesDivisionsStyleLabel = jwidgetEdition.getBundle()
					.getString("gridVerticalLinesDivisionsDash");
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		...
		periodRadioButtonsListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(13), Boolean
		...
		durationTimeChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(14), durationTimeChooser
						.getValue(), false);
			}
		};
		...
		colorChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(15), colorChooser.getValue(),
						true);
			}
		};
		...
		lineStyleChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(16), lineStyleChooser
						.getValue(), false);
			}
		};
