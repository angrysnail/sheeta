...
public class VerticalGridLinesSubDivisionsPanel extends JPanel {
	 ...
	 * the jlabels
	 */
	private JLabel durationTimeChooserLbl, backgroundColorLbl,
			lineStyleChooserLbl;
	...
	public void initialize(Element element) {
		...
		automaticPeriodRadioButton
				.removeActionListener(periodRadioButtonsListener);
		manualPeriodRadioButton
				.removeActionListener(periodRadioButtonsListener);

		boolean handleAutomatically = true;

		try {
			handleAutomatically = Boolean.parseBoolean(jwidgetEdition
		...
		automaticPeriodRadioButton
				.addActionListener(periodRadioButtonsListener);
		...
		durationTimeChooser.init(jwidgetEdition.getProperty(element,
				jwidgetEdition.getPropertiesList().get(17)));
		...
		colorChooser.init(jwidgetEdition.getProperty(element, jwidgetEdition
				.getPropertiesList().get(18)));
		colorChooser.addListener(colorChooserListener);

		lineStyleChooser.removeListener(lineStyleChooserListener);
		lineStyleChooser.init(jwidgetEdition.getProperty(element,
				jwidgetEdition.getPropertiesList().get(19)));
	...
	protected void build() {
		...
		// getting the labels
		String gridVerticalLinesSubDivisionsLabel = "", gridVerticalLinesSubDivisionsAutomaticPeriodLabel = "", gridVerticalLinesSubDivisionsDurationLabel = "", gridVerticalLinesSubDivisionsColorLabel = "", gridVerticalLinesSubDivisionsStyleLabel = "";

		try {
			gridVerticalLinesSubDivisionsLabel = jwidgetEdition.getBundle()
					.getString("gridVerticalLinesSubDivisions");
			gridVerticalLinesSubDivisionsAutomaticPeriodLabel = jwidgetEdition
					.getBundle().getString(
							"gridVerticalLinesSubDivisionsAutomaticPeriod");
			gridVerticalLinesSubDivisionsDurationLabel = jwidgetEdition
					.getBundle().getString(
							"gridVerticalLinesSubDivisionsDuration");
			gridVerticalLinesSubDivisionsColorLabel = jwidgetEdition
					.getBundle()
					.getString("gridVerticalLinesSubDivisionsColor");
			gridVerticalLinesSubDivisionsStyleLabel = jwidgetEdition
					.getBundle().getString("gridVerticalLinesSubDivisionsDash");
		} catch (Exception ex) {
			ex.printStackTrace();
		}

		// creating the jlabel for the time chooser
		durationTimeChooserLbl = new JLabel(
				gridVerticalLinesSubDivisionsDurationLabel + " : ");
		durationTimeChooserLbl.setHorizontalAlignment(SwingConstants.RIGHT);

		// creating the radio buttons
		automaticPeriodRadioButton = new JRadioButton(
				gridVerticalLinesSubDivisionsAutomaticPeriodLabel);
		...
		periodRadioButtonsListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(27), Boolean
						.toString(automaticPeriodRadioButton.isSelected()),
						false);
				handleButtonsState();
			}
		};
		...
		durationTimeChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(17), durationTimeChooser
						.getValue(), false);
			}
		};
		...
		colorChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(18), colorChooser.getValue(),
						true);
			}
		};

		// creating the jlabel for the line style chooser
		lineStyleChooserLbl = new JLabel(
				gridVerticalLinesSubDivisionsStyleLabel + " : ");
		lineStyleChooserLbl.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		lineStyleChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(19), lineStyleChooser
						.getValue(), false);
			}
		};
		...
		TitledBorder border = new TitledBorder(
				gridVerticalLinesSubDivisionsLabel);
		setBorder(border);
	...
	/**
	 * modifies the state of the manual period widgets according to the state of
	 * the radio buttons
	 */
	protected void handleButtonsState() {

		durationTimeChooser
				.setEnabled(!automaticPeriodRadioButton.isSelected());
	}
}
