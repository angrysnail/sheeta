...
public class HistoryPanel extends JPanel {
	...
	public void initialize(Element element) {
		...
		tagChooser1.init(element.getAttribute(jwidgetEdition
				.getPropertiesList().get(28)));
		tagChooser2.init(element.getAttribute(jwidgetEdition
				.getPropertiesList().get(29)));
	}
	...
	protected void build() {
		...
		// getting the labels
		String historicLabel = "", keepAliveLabel = "", historicPeriodFromTagsLabel = "", tag1Label = "", tag2Label = "";

		try {
			historicLabel = jwidgetEdition.getBundle().getString("historic");
			keepAliveLabel = jwidgetEdition.getBundle().getString("keepAlive");
			historicPeriodFromTagsLabel = jwidgetEdition.getBundle().getString(
					"historicPeriodFromTags");
		...
		checkBoxActionListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(20), Boolean.toString(checkBox
						.isSelected()), true);
			}
		};
		...
		tagListener1 = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(28), tagChooser1
		...
		tagListener2 = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jwidgetEdition.setProperty(currentElement, jwidgetEdition
						.getPropertiesList().get(29), tagChooser2
						.getCurrentValue(), false);
			}
		};
