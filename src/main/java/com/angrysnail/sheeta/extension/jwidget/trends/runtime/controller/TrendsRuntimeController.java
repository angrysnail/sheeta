package com.angrysnail.sheeta.extension.jwidget.trends.runtime.controller;
...
/**
 * the class that is the link between the model and the view parts and which
 * provides methods for interacting with the trends widgets
 * 
...
public class TrendsRuntimeController {
	...
	public TrendsRuntimeController(TrendsRuntime jwidgetRuntime) {
		...
		// creating the object that stores all the configuration properties
		// values
		configuration = new TrendsConfiguration(this,
				jwidgetRuntime.getJWidgetElement());
