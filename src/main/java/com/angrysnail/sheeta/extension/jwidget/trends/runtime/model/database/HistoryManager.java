package com.angrysnail.sheeta.extension.jwidget.trends.runtime.model.database;
...
public class HistoryManager {
	 ...
	 *            the subprotocol
	 * @param host
	 *            the host for the data base url
	 * @param dbName
	 *            the data base name
	 * @param user
	 *            the user
	 ...
	 *            the password
	 */
	public HistoryManager(String id, String driverName, String subProtocol,
