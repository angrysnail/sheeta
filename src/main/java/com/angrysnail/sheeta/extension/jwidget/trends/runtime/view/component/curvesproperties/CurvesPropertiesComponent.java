...
/**
 * the class of the component used to display the widgets used to modify the
 * curve's properties
 * 
...
public class CurvesPropertiesComponent {
	...
	public void initialize() {
		...
		internalFrame.setFrameIcon(TrendsIcons.getIcon(
				DisplayCurvesPropertiesTool.id, false));
		internalFrame
				.setTitle(TrendsBundle.bundle.getString("CurveProperties"));

		internalFrame.getContentPane().add(contentPanel);
		internalFrame.setVisible(false);
		handler.getView().getController().getJwidgetRuntime().getPicture()
				.getDesktop().add(internalFrame, new Integer(1000000));
	}
	 ...
	 * 
	 * @param visible
	 *            whether the internal frame should be visible or not
	 * @param location
	 *            the location of the internal frame
	 */
