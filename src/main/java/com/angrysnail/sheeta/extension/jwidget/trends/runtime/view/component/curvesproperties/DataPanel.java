...
public class DataPanel extends JPanel {
	 ...
	 * the textfields
	 */
	private JTextField labelTxt, tagNameTxt, currentValueTxt, lowerLimitTxt,
			higherLimitTxt;
	...
	public DataPanel(CurvesPropertiesComponent curvesPropertiesComponent) {
		...
		this.componentsHandler = curvesPropertiesComponent
	...
	protected void build() {
		...
		String tagCurrentValueLabel = TrendsBundle.bundle
				.getString("TagCurrentValue");
	...
	public void changeCurve(TrendsCurveConfiguration trendsCurveConfiguration) {
		...
		if (trendsCurveConfiguration != null) {
			...
			if (trendsCurveConfiguration.isEnumeratedTag()) {
				...
				lowerLimitTxt.setText(componentsHandler
						.getStringRepresentation(trendsCurveConfiguration
								.getMinValue()));
				higherLimitTxt.setText(componentsHandler
						.getStringRepresentation(trendsCurveConfiguration
								.getMaxValue()));
	...
	public void setCurrentValue(Object currentValue) {
		...
		if (currentValue instanceof String) {
			...
			currentValueTxt.setText(componentsHandler
					.getStringRepresentation((Double) currentValue));
		}
	}
}
