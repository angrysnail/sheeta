package com.angrysnail.sheeta.extension.jwidget.trends.runtime.view.component.curvesproperties;
...
import com.angrysnail.sheeta.library.widgets.ColorChooserWidget;
...
/**
 * the class of the panel displaying the widgets used to display and modify the
 * curves style properties
 * 
...
public class StylePanel extends JPanel {
	...
	protected void build() {
		...
		// getting the labels
		String displayScaleLabel = TrendsBundle.bundle
				.getString("DisplayScale");
		...
		String curveThicknessLabel = TrendsBundle.bundle
				.getString("CurveThickness");
		String curveInterpolationLabel = TrendsBundle.bundle
				.getString("CurveInterpolation");
		...
		displayScaleCheckBoxListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (curveConfiguration != null) {
					...
					curveConfiguration.setDisplayScale(displayScaleCheckBox
							.isSelected());
				}
			}
		};
		...
		colorChooserWidgetListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (curveConfiguration != null) {
					...
					curveConfiguration.setColor(colorChooserWidget
							.getCurrentColor());
				}
			}
		};
		...
		thicknessChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (curveConfiguration != null) {
					...
					curveConfiguration.setThickness(thicknessChooser
							.getWidgetValue());
				}
			}
		};
		...
		lineInterpolationChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (curveConfiguration != null) {
					...
					curveConfiguration
							.setInterpolationType(lineInterpolationChooser
									.getValue());
				}
			}
		};
		...
		pointStyleChooserWidgetListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (curveConfiguration != null) {
					...
					curveConfiguration.setPoint(pointStyleChooserWidget
							.getValue());
				}
			}
		};
	 ...
	 * 
	 * @param trendsCurveConfiguration
	 *            the trends curve configuration
	 */
	public void changeCurve(TrendsCurveConfiguration trendsCurveConfiguration) {
		...
		if (curveConfiguration != null) {
			...
			curveConfiguration
					.removeCurvesConfigurationChangeListener(listener);
		}
	...
	protected void updateStyleValues() {
		...
		if (curveConfiguration != null) {
			...
			lineInterpolationChooser
					.removeListener(lineInterpolationChooserListener);
			pointStyleChooserWidget
					.removeListener(pointStyleChooserWidgetListener);
			...
			lineInterpolationChooser
					.init(curveConfiguration.getInterpolation());
			...
			lineInterpolationChooser
					.addListener(lineInterpolationChooserListener);
			pointStyleChooserWidget
					.addListener(pointStyleChooserWidgetListener);
		}
	}
