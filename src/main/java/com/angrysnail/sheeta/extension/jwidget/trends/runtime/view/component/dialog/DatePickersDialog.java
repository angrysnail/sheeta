package com.angrysnail.sheeta.extension.jwidget.trends.runtime.view.component.dialog;
...
import com.angrysnail.sheeta.extension.jwidget.trends.runtime.view.TrendsRuntimeView;
import com.angrysnail.sheeta.library.widgets.DateAndTimeChooserWidget;
...
public class DatePickersDialog extends TitledDialog {
	...
	protected JPanel buildContentPanel() {
		...
		String informationMessage = TrendsBundle.bundle
				.getString("DatePickersDialogMessage");
		String startDateLabel = TrendsBundle.bundle.getString("StartDate");
		String endDateLabel = TrendsBundle.bundle.getString("EndDate");
		final String startHigherThanEndDateLabel = TrendsBundle.bundle
				.getString("StartHigherThanEndDate");
		final String timeZoneTooLargeLabel = TrendsBundle.bundle
				.getString("TimeZoneTooLarge");
		...
		ActionListener widgetsListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				} else if (Math.abs(endDate - startDate) > view.getController()
						.getConfiguration().getMaxDisplayableTime()) {
		...
		startDatePanel
				.setLayout(new BoxLayout(startDatePanel, BoxLayout.X_AXIS));
