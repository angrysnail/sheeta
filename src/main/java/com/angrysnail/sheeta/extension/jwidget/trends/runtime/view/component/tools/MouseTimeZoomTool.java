...
public class MouseTimeZoomTool extends JButton {
	 ...
	 * @author ITRIS, Jordi SUC
	 */
	protected class MouseTimeZoomToolListener extends MouseAdapter
			implements
				MouseMotionListener {
		...
		public void mousePressed(MouseEvent evt) {
			...
			if (componentsHandler.getCurrentAction().equals(id)) {
				...
				if (curvesBounds != null && evt.getX() >= curvesBounds.x
					...
					firstLinePainter.getPath().moveTo(firstPoint.x,
							curvesBounds.y);
					firstLinePainter.getPath().lineTo(firstPoint.x,
							curvesBounds.y + curvesBounds.height);
		...
		public void mouseDragged(MouseEvent evt) {
			...
			if (firstPoint != null && curvesBounds != null
					&& evt.getX() >= curvesBounds.x
					&& evt.getX() <= (curvesBounds.x + curvesBounds.width)) {

				// getting the previous bounds
				Rectangle previousBounds = new Rectangle(
						secondLinePainter.getBounds());
				...
				secondLinePainter.getPath().lineTo(evt.getX(),
						curvesBounds.y + curvesBounds.height);
