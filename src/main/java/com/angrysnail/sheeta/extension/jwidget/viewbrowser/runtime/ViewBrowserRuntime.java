package com.angrysnail.sheeta.extension.jwidget.viewbrowser.runtime;

import org.w3c.dom.Element;

import com.angrysnail.sheeta.extension.jwidget.viewbrowser.edition.ViewBrowserEdition;
...
public class ViewBrowserRuntime extends JWidgetRuntime {
	...
	public void initialize() {
		...
		try {
			showHeader = Boolean.parseBoolean(element
					.getAttribute(showHeaderAttribute));
		} catch (Exception ex) {
		}

		ViewBrowser viewBrowser = new ViewBrowser(picture.getMainDisplay(),
				element.getAttribute(jwidgetIdAttributeName), showHeader);
	...
	public void initializeWhenCanvasDisplayed() {
		...
		if (viewPath != null && !viewPath.equals("")) {
			...
			((ViewBrowser) component).getPictureLoader().setCurrentPicture(uri,
					false);
		}
	}
