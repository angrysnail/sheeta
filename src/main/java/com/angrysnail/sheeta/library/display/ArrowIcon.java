package com.angrysnail.sheeta.library.display;
...
public class ArrowIcon {
	 ...
	 */
	public static final Rectangle arrowIconBounds = new Rectangle(
			defaultIconSize.width, 0, 8, 7);
	...
	public ArrowIcon() {
		...
		iconImage = new BufferedImage(defaultIconSize.width
				+ arrowIconBounds.width + offset, defaultIconSize.height,
