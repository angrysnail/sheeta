package com.angrysnail.sheeta.library.monitor;
...
public class Monitor {
	 ...
	 */
	public Monitor(Component parent, JComponent relativeComponent, int min,
			int max) {
	 ...
	 * 
	 * @param indeterminate
	 *            whether the progress dialog should be in an indeterminate
	 *            state
	 */
	...
	public void setProgress(final int value) {
		...
		enqueue(new Runnable() {
			...
			public void run() {
				...
				waitDialog.setProgressMessage(currentMessage, value, min, max);
			}
		});
	}
	...
	public void incrementProgressValue() {
		...
		enqueue(new Runnable() {
			...
			public void run() {
				...
				waitDialog.setProgressMessage(currentMessage,
						Monitor.this.value, min, max);
			}
		});
	}

	/**
	 * @return whether the action monitored by this object has been cancelled
	 */
