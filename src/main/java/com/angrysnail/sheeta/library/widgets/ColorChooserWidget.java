...
public class ColorChooserWidget extends Widget {
	...
	public void init(Object objectValue) {
		...
		if (objectValue != null) {
			...
			if (objectValue instanceof Color) {
				...
				currentValue = ColorsAndBlinkingsToolkit
				...
				if (colorString.equals("")) {
					...
					Color color = ColorsAndBlinkingsToolkit
	...
	public Color showColorChooserDialog(Color initialColor) {
		...
		JDialog dialog = JColorChooser.createDialog(getTopLevelAncestor(), "",
				true, colorChooser, ok, null);
