...
import com.angrysnail.sheeta.library.Bundle;
...
public class FileDialog {
	 ...
	 *            the array of the file extensions that should appear in the
	 *            file chooser
	 * @param startFile
	 *            the file that should be initialy shown in the file chooser
	 * @param excludedFiles
	 *            the array of the files that should not be displayed
	 * @return the choosen file
	 */
	public File askForFile(final String[] fileExtensions, File startFile,
			File[] excludedFiles) {
			...
			public boolean accept(File theFile) {
				...
				for (String extension : fileExtensions) {
					...
					if (theFile.isDirectory()
							|| (!excludedFilesSet.contains(theFile) && fileName
									.endsWith(extension))) {
