...
import com.angrysnail.sheeta.rtda.components.picture.SVGPictureManager;
import com.angrysnail.sheeta.rtda.components.viewbrowser.ViewBrowser;
import com.angrysnail.sheeta.rtda.components.viewbrowser.ViewBrowsersManager;
...
public class MainDisplay {
	 ...
	 * 
	 * @param mainDisplayToolkit
	 *            the main display toolkit
	 * @param isTestVersion
	 *            whether the currently running version is a test version
	 * @param isDebugMode
	...
	public MainDisplay(MainDisplayToolkit mainDisplayToolkit,
		...
		animationsHandler = new AnimationsHandler(this, isTestVersion,
				isDebugMode);
		...
		animationsHandler
				.addRequireViewDisplayListener(new RequireViewDisplayListener() {

					@Override
					public void displayView(String id, String uri) {

						// getting the view browser corresponding to the given
						// id
						ViewBrowser viewBrowser = viewBrowsersManager
								.getViewBrowser(id);

						if (viewBrowser != null) {

							viewBrowser.getPictureLoader().setCurrentPicture(
									uri, false);
						}
					}
					...
					public void displayPreviousView(String id) {
						...
						if (viewBrowser != null) {
							...
							viewBrowser.getPictureLoader()
									.returnToPreviousPicture();
						}
					}
