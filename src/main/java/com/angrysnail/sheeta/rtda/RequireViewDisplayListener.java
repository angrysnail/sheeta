 ...
 */
public abstract class RequireViewDisplayListener
		implements
	 ...
	 * @param uri
	 *            the uri of the view that should be displayed
	 */
	public abstract void displayView(String id, String uri);

	/**
	 * requires to display the view that has been displayed before the current
	 * view
	 * 
	 * @param id
