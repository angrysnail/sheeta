...
public abstract class AbstractRecordData
	 ...
	 *            jwidget
	 */
	public AbstractRecordData(SVGPicture picture, String projectName,
	...
	public void performAction(Object evt) {
		...
		if (isEntitled() && isAuthorized && showConfirmationDialog()) {
			...
			// computing the map associating a table field to its corresponding
			// tag value
			Map<String, Object> fieldNameToValueMap = new HashMap<String, Object>();
	...
	protected class RecordDataDataBaseAccess extends DataBaseAccess {
		 ...
		 *            the table name
		 */
		public RecordDataDataBaseAccess(SVGPicture picture, String dbName,
				String tableName) {
