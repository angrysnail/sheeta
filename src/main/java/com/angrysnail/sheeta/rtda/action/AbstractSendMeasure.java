 ...
 */
public abstract class AbstractSendMeasure
		extends
	 ...
	 *            jwidget
	 */
	public AbstractSendMeasure(SVGPicture picture, String projectName,
	...
	public void performAction(Object evt) {
		...
		if (isEntitled() && isAuthorized && showConfirmationDialog()) {
			...
			int returnValue = numberChooser.showNumberChooser(picture
			...
			if (returnValue == NumberChooser.OK_ACTION) {
				...
				if (!Double.isNaN(enteredNumber)
					...
					if (!Double.isNaN(tagMinValue)
						...
						Object oldObj = getData(actionElement
