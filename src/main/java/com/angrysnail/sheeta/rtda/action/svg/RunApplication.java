...
public class RunApplication extends AbstractRunApplication {
	 ...
	 *            jwidget
	 */
	public RunApplication(SVGPicture picture, String projectName,
	...
	protected void initializeAction() {
		...
		try {
			toolTipText = bundle.getString("tooltip_runApplication") + "<i>"
					+ actionElement.getAttribute(commandAttributeName) + "</i>";
		} catch (Exception ex) {
		}
	}
}
