...
public class SVGEventsManager extends EventsManager {
	...
	/**
	 * the map associating an event type to a set of the events by which this
	 * action is triggered
	 */
	...
	/**
	 * performs this action given the type of the event (this method should only
	 * be used with actions on svg shapes; it will not be called for jwidgets)
	 * 
	 * @param eventType
	 *            the type of the event
	 * @param modifier
	 *            the modifier mask (@see java.aw.event.InputEvent for the
	 *            modifiers codes)
	 * @param key
	 *            the tapped key if the event is a key one (@see
	 *            java.awt.event.KeyEvent for the key codes)
	 */
	...
	/**
	 * returns whether the given event corresponds to one of the events defined
	 * in this action
	 * 
	 * @param eventType
	 ...
	 *            the modifier
	 * @param eventKey
	 *            the key if the event is a key event
	 * @return returns the given event corresponds to one of the events defined
	 *         in this action
	 */
	public boolean isEvent(int eventType, int eventModifier, int eventKey) {

		boolean isEvent = false;
		boolean isKey = (eventType == KEY_DOWN || eventType == KEY_UP || eventType == KEY_TYPED);
	...
	/**
	 * creates the set of the event objects for which this action should be
	 * triggered
	 * 
	 * @param value
	 *            the events value
