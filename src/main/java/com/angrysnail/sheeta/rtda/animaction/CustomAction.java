...
public abstract class CustomAction extends Action {
	 ...
	 *            jwidget
	 */
	public CustomAction(SVGPicture picture, String projectName,
	...
	/**
	 * @return the name of the class that will be used to create the dialog used
	 *         to configure this action or <b>null</b> if no configuration
