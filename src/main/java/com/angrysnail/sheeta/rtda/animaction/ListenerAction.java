...
public interface ListenerAction {
	...
	/**
	 * the method called when the data to which the listener or action is
	 * registered, is modified. A runnable should only be returned if a svg
	 * element has to be modified
	 * 
	 * @param evt
	 *            an event
	...
	/**
	 * @return whether this listener or action allowed the display or invalid
	 *         icons when a tag is invalid
	 */
