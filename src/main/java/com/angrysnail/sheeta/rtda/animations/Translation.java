...
public class Translation extends DataChangedListener {
	 ...
	 */
	private double minTranslationX = 0, minTranslationY = 0,
			maxTranslationX = 0, maxTranslationY = 0;
	...
	public Translation(SVGPicture picture, Element animationElement) {
		...
		String xRef = animationElement.getAttribute("xRef"), yRef = animationElement
	...
	public Runnable dataChanged(DataEvent evt) {
		...
		if (!Double.isNaN(tagValue) && !Double.isNaN(tagMinValue)
			...
			if (amplitude > 0) {
				...
				newTranslationX = (maxTranslationX - minTranslationX) * ratio
						+ minTranslationX;
				newTranslationY = (maxTranslationY - minTranslationY) * ratio
						+ minTranslationY;
