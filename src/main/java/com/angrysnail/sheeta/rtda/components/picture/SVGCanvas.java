...
public class SVGCanvas extends JSVGCanvas {
	...
	public Dimension getCanvasSize(Document doc) {
		...
		if (doc != null) {
			...
			if (root != null) {
				...
				int w = (int) getPixelledNumber(root.getAttributeNS(null,
						"width"));
				int h = (int) getPixelledNumber(root.getAttributeNS(null,
						"height"));
	...
	/**
	 * @author ITRIS, Jordi SUC the class defining a modified implementation of
	 *         a user agent
	 */
	protected class SVGCanvasUserAgent
			extends
