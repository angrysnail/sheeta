...
public class SVGPictureManager {
	...
	/**
	 * the map of all the loaded svg pictures, associating the id of a picture
	 * to this picture
	 */
	protected Map<String, SVGPicture> pictures = new HashMap<String, SVGPicture>();

	/**
	 * the map of all the xml configuration documents, associating a project
	 * name to its related configuration document
	 */
	protected Map<String, ConfigurationDocument> configurationDocuments = new HashMap<String, ConfigurationDocument>();

	/**
	 * the map associating the name of a project to the map associating the xml
	 * path of a svg file to its uri
	 */
	protected Map<String, Map<String, String>> projectNameToViewPathsToUriMap = new HashMap<String, Map<String, String>>();

	/**
	 * the map associating the name of a project to the map associating the uri
	 * of a svg file to its xml path
	 */
	protected Map<String, Map<String, String>> projectNameToUriToXMLPathMap = new HashMap<String, Map<String, String>>();
	...
	public void addPicture(SVGPicture picture) {
		...
		if (projectName != null && !projectName.equals("")
			...
			Map<String, String> map = getViewsPathToUriMap(configurationDocuments
					.get(projectName));

			// getting the absolute path of the container of the files for this
			// project
			String startPath = picture.getCanvas().getProjectFile().toURI()
					.toASCIIString();
	...
	public void removePicture(SVGPicture picture) {
		...
		Set<String> unusedProjectNames = new HashSet<String>(
				projectNameToViewPathsToUriMap.keySet());
	...
	public String getViewUri(String projectFileName, String xmlViewPath) {
		...
		if (projectFileName != null && !projectFileName.equals("")
			...
			Map<String, String> map = projectNameToViewPathsToUriMap
					.get(projectFileName);
	...
	public String getViewXMLPath(String projectFileName, String uri) {
		...
		if (projectFileName != null && !projectFileName.equals("")
			...
			Map<String, String> map = projectNameToUriToXMLPathMap
					.get(projectFileName);
	...
	/**
	 * returns the map associating the xml path of a view to uri of the
	 * corresponding svg file
	 * 
	 * @param confDoc
	 *            the document of the xml data base
	 * @return the map of the xml path and uris
	 */
	public Map<String, String> getViewsPathToUriMap(
		...
		if (confDoc != null) {
			...
			NodeList allViewElements = confDoc.getRootElement()
