...
public class ViewBrowserPopupDialog extends JDialog {
	 ...
	 * @param viewPath
	 *            the path of the view to display
	 * @param projectName
	 *            the name of the current project
	 * @param relativeComponent
	 *            the relative component for the dialog to display
	 */
	public ViewBrowserPopupDialog(MainDisplay mainDisplay, Frame parentFrame,
			String viewPath, String projectName, JComponent relativeComponent) {
	 ...
	 *            the relative component for the dialog to display
	 */
	public ViewBrowserPopupDialog(MainDisplay mainDisplay, JDialog parent,
			String viewPath, String projectName, JComponent relativeComponent) {
	...
	protected void build() {
		...
		viewBrowser = new ViewBrowser(mainDisplay, mainDisplay
				.getViewBrowsersManager().getUniqueIdForViewBrowser(), false);
		...
		mainDisplay.getViewBrowsersManager().registerViewBrowser(viewBrowser);
	...
	public void dispose() {
		...
		mainDisplay.getViewBrowsersManager().unregisterViewBrowser(viewBrowser);
		viewBrowser.dispose();
		viewBrowser.clear();
