...
import com.angrysnail.sheeta.rtda.animaction.CustomAction;
...
public abstract class JWidgetRuntime implements ListenerAction {
	 ...
	 */
	protected Map<String, TestTagInformation> dataNamesToTestTagInfo = new ConcurrentHashMap<String, TestTagInformation>();

	/**
	 * the list of the animations of the jwidget runtime object
	 */
	protected List<JWidgetAnimation> animations = new CopyOnWriteArrayList<JWidgetAnimation>();
	 ...
	 * 
	 * @param picture
	 *            the picture this jwidget registers
	 * @param element
	 *            the svg element defining the jwidget
	 */
	...
	/**
	 * creates and returns the animation object corresponding to the given
	 * animation element
	 * 
	...
	/**
	 * creates and returns the action object corresponding to the given action
	 * element
	 * 
	 * @param actionElement
	 *            an action element
	 ...
	 */
	public com.angrysnail.sheeta.rtda.animaction.Action createAction(
	...
	/**
	 * refreshes the state of the component according to the state of its
	 * actions
	 */
	 ...
	 * 
	 * @param animation
	 *            an animation linked to this jwidget runtime object
	 */
	 ...
	 * 
	 * @param action
	 *            an action linked to this jwidget runtime object
	 */
	...
	/**
	 * @return the map associating the id of a sub component to its set of
	 *         actions (this method should only be called by jwidgets that
	 *         register action to their sub component)
	 */
	public Map<String, Set<Action>> getSubComponentIdToActionsMap() {

		Map<String, Set<Action>> map = new HashMap<String, Set<Action>>();
