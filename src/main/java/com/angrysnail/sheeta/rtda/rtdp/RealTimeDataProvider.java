...
public abstract class RealTimeDataProvider {
	...
	/**
	 * @param isStarted
	 *            whether the provider should start or stop
	 */
	...
	/**
	 * sets the new value for the given data from this rtdp to the animations
	 * handler
	 * 
	 * @param name
	 *            the name of a data
	 ...
	 *            the new value
	 */
	public abstract void setDataValueForAnimationsHandler(String name,
			Object newValue);

	/**
	 * sets the new value for the given data from this rtdp to the external data
	 * source
	 * 
	 * @param name
	 *            the name of a data
