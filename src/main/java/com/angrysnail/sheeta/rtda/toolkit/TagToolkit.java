package com.angrysnail.sheeta.rtda.toolkit;
...
public class TagToolkit {
	...
	static {
		...
		if (bundle != null) {
			...
			try {
				...
				enumeratedValueLabel = bundle
						.getString("rtdadb_enumeratedvalue");
				...
				enumeratedTagIdLabel = bundle
						.getString("rtdadb_enumeratedtagid");
				stringTagIdLabel = bundle.getString("rtdadb_stringtagid");
				enumeratedValueIdLabel = bundle
						.getString("rtdadb_enumeratedvalueid");
	...
	/**
	 * returns the name associated with a tag, a view, a module, or the "none"
	 * type
	 * 
	 * @param type
	 *            the type
	 * @return the name associated with a tag, a view, a module, or the "none"
	 *         type
	 */
	...
	/**
	 * returns the label associated with a tag, a view, a module, or the "none"
	 * type
	 * 
	 * @param type
	 *            the type
	 * @return the label associated with a tag, a view, a module, or the "none"
	 *         type
	 */
	...
	/**
	 * returns the label of the default id (for the widget data base) associated
	 * with a tag, a view, a module, or the "none" type
	 * 
	 * @param type
	 *            the type
	 ...
	 *            whether the equivalence is an equality or not
	 * @return whether the two given types are equivalent or not
	 */
	public static boolean areTypesEquivalent(int type1, int type2,
	...
	/**
	 * creates and returns the xml path of an given element of this compiled xml
	 * file
	 * 
	 * @param element
	 *            an element
