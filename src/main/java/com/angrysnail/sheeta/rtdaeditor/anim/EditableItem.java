...
public abstract class EditableItem {
	...
	/**
	 * returns the map of the possible values for the given attribute of the
	 * group attribute
	 * 
	 * @param name
	 *            the name of an attribute of the group
	 * @return the map of the possible values for the given attribute of the
	 *         group attribute
	 */
	...
	/**
	 * returns the list of all the ids of the svg shapes and jwidgets that can
	 * be found in the given document
	 * 
	 * @param root
	 *            the root element
	 * @return the list of all the ids of the svg shapes and jwidgets that can
	 *         be found in the given document
	 */
	 ...
	 * 
	 * @param root
	 *            the root element from which the id of the view browsers should
	 *            be retrieved
	...
	public static LinkedHashMap<String, String> getViewBrowsersIds(Element root) {
		...
		NodeList jwidgetElements = root
				.getElementsByTagName(com.angrysnail.sheeta.library.Toolkit.jwidgetElementName);
		...
		if (jwidgetElements != null) {
			...
			for (int i = 0; i < jwidgetElements.getLength(); i++) {
				...
				if (element != null
						&& element
								.getAttribute(
										com.angrysnail.sheeta.library.Toolkit.nameAttribute)
