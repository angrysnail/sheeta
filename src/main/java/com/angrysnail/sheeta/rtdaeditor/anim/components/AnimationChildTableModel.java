...
import com.angrysnail.sheeta.rtdaeditor.anim.ChildObject;
...
public class AnimationChildTableModel extends AnimationTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		if (animationObject != null
				&& animationObject.getChildrenList().size() > rowIndex) {

			ChildObject childObject = animationObject.getChildrenList().get(
					rowIndex);

			if (childObject != null
					&& childObject.getAttributesList().size() > columnIndex) {
