...
public class AnimationTable extends JTable {
	 ...
	 *            the animation panel
	 * @param isPropertyTable
	 *            whether the model should be for the properties or for the
	 *            children objects
	 */
	...
	public void computeColumnsWidth() {
		...
		if (g != null) {
			...
			for (int i = 0; i < getColumnCount(); i++) {
				...
				if (!getColumnName(i).equals(useLabel)
						&& !getColumnName(i).equals(boundsLabel)) {
