...
public class HeaderPanel extends JPanel {
	 ...
	 * 
	 * @param rtdaAnimationsAndActions
	 *            the animations and actions module
	 * @param testLaunchButton
	 *            the button used to launch the test dialog
	 */
	public HeaderPanel(RtdaAnimationsAndActionsModule rtdaAnimationsAndActions,
			JButton testLaunchButton) {

		this.rtdaAnimationsAndActions = rtdaAnimationsAndActions;
		this.testLaunchButton = testLaunchButton;

		descriptionLabel = ResourcesManager.bundle
				.getString("rtdaanim_headerElementName");
		noHandleOpenLabel = ResourcesManager.bundle
				.getString("rtdaanim_noHandleOpen");
		tagEventModeLabel = ResourcesManager.bundle
				.getString("rtdaanim_tagEventMode");
	...
	public String getLabel(Element element) {
		...
		if (element != null) {
			...
			if (com.angrysnail.sheeta.library.Toolkit
				...
				JWidgetEdition jwidgetEdition = rtdaAnimationsAndActions
						.getJwidgetManager()
						.getJWidgetEdition(
								jwidgetElement
