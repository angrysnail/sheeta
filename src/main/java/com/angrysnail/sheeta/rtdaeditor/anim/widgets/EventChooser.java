...
import com.angrysnail.sheeta.rtda.action.svg.SVGEventsManager;
...
public class EventChooser extends Widget {
	...
	KeyEvent.VK_0, KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_3, KeyEvent.VK_4,
			...
			KeyEvent.VK_9, KeyEvent.VK_A, KeyEvent.VK_ALL_CANDIDATES,
			...
			KeyEvent.VK_BRACELEFT, KeyEvent.VK_BRACERIGHT, KeyEvent.VK_C,
			...
			KeyEvent.VK_CONTEXT_MENU, KeyEvent.VK_CONTROL, KeyEvent.VK_D,
			KeyEvent.VK_DECIMAL, KeyEvent.VK_DELETE, KeyEvent.VK_DIVIDE,
			KeyEvent.VK_DOLLAR, KeyEvent.VK_DOWN, KeyEvent.VK_E,
			KeyEvent.VK_END, KeyEvent.VK_ENTER, KeyEvent.VK_EQUALS,
			KeyEvent.VK_ESCAPE, KeyEvent.VK_EURO_SIGN,
			KeyEvent.VK_EXCLAMATION_MARK, KeyEvent.VK_F, KeyEvent.VK_F1,
			...
			KeyEvent.VK_F18, KeyEvent.VK_F19, KeyEvent.VK_F2, KeyEvent.VK_F20,
			...
			KeyEvent.VK_F7, KeyEvent.VK_F8, KeyEvent.VK_F9, KeyEvent.VK_G,
			KeyEvent.VK_GREATER, KeyEvent.VK_H, KeyEvent.VK_HOME,
			KeyEvent.VK_I, KeyEvent.VK_INSERT, KeyEvent.VK_J, KeyEvent.VK_K,
			KeyEvent.VK_KP_DOWN, KeyEvent.VK_KP_LEFT, KeyEvent.VK_KP_RIGHT,
			KeyEvent.VK_KP_UP, KeyEvent.VK_L, KeyEvent.VK_LEFT,
			KeyEvent.VK_LEFT_PARENTHESIS, KeyEvent.VK_LESS, KeyEvent.VK_M,
			KeyEvent.VK_META, KeyEvent.VK_MINUS, KeyEvent.VK_MULTIPLY,
			KeyEvent.VK_N, KeyEvent.VK_NUM_LOCK, KeyEvent.VK_NUMBER_SIGN,
			...
			KeyEvent.VK_NUMPAD9, KeyEvent.VK_O, KeyEvent.VK_OPEN_BRACKET,
			KeyEvent.VK_P, KeyEvent.VK_PAGE_DOWN, KeyEvent.VK_PAGE_UP,
			KeyEvent.VK_PAUSE, KeyEvent.VK_PERIOD, KeyEvent.VK_PLUS,
			KeyEvent.VK_PRINTSCREEN, KeyEvent.VK_Q, KeyEvent.VK_QUOTE,
			KeyEvent.VK_QUOTEDBL, KeyEvent.VK_R, KeyEvent.VK_RIGHT,
			KeyEvent.VK_RIGHT_PARENTHESIS, KeyEvent.VK_ROMAN_CHARACTERS,
			KeyEvent.VK_S, KeyEvent.VK_SCROLL_LOCK, KeyEvent.VK_SEMICOLON,
			KeyEvent.VK_SEPARATOR, KeyEvent.VK_SHIFT, KeyEvent.VK_SLASH,
			KeyEvent.VK_SPACE, KeyEvent.VK_SUBTRACT, KeyEvent.VK_T,
			KeyEvent.VK_TAB, KeyEvent.VK_U, KeyEvent.VK_UNDERSCORE,
			KeyEvent.VK_UP, KeyEvent.VK_V, KeyEvent.VK_W, KeyEvent.VK_WINDOWS,
			KeyEvent.VK_X, KeyEvent.VK_Y, KeyEvent.VK_Z};

	/**
	 * the array of the modifiers
	 */
	public static Integer[] modifiersArray = {InputEvent.BUTTON1_DOWN_MASK,
			InputEvent.BUTTON2_DOWN_MASK, InputEvent.BUTTON3_DOWN_MASK,
			InputEvent.ALT_GRAPH_DOWN_MASK, InputEvent.ALT_DOWN_MASK,
		...
		Comparator<Integer> comparator = new Comparator<Integer>() {
			...
			public int compare(Integer integer0, Integer integer1) {
				...
				if (integer0 != null && integer1 != null) {
					...
					return KeyEvent.getKeyText(integer0).compareTo(
							KeyEvent.getKeyText(integer1));
				}
		...
		comparator = new Comparator<Integer>() {
			...
			public int compare(Integer integer0, Integer integer1) {
				...
				if (integer0 != null && integer1 != null) {
					...
					return KeyEvent.getKeyModifiersText(integer0).compareTo(
							KeyEvent.getKeyModifiersText(integer1));
				}
	...
	protected EventChooser(boolean isEditor) {
		...
		eventItems.put(SVGEventsManager.MOUSE_DOWN, new EventItem(
				SVGEventsManager.MOUSE_DOWN));
		eventItems.put(SVGEventsManager.MOUSE_UP, new EventItem(
				SVGEventsManager.MOUSE_UP));
		eventItems.put(SVGEventsManager.CLICK, new EventItem(
				SVGEventsManager.CLICK));
		eventItems.put(SVGEventsManager.MOUSE_OVER, new EventItem(
				SVGEventsManager.MOUSE_OVER));
		eventItems.put(SVGEventsManager.MOUSE_OUT, new EventItem(
				SVGEventsManager.MOUSE_OUT));
		eventItems.put(SVGEventsManager.MOUSE_MOVE, new EventItem(
				SVGEventsManager.MOUSE_MOVE));
		eventItems.put(SVGEventsManager.KEY_UP, new EventItem(
				SVGEventsManager.KEY_UP));
		eventItems.put(SVGEventsManager.KEY_DOWN, new EventItem(
				SVGEventsManager.KEY_DOWN));
		eventItems.put(SVGEventsManager.KEY_TYPED, new EventItem(
				SVGEventsManager.KEY_TYPED));

		// filling the events map
		try {
			ResourceBundle bundle = ResourcesManager.bundle;
			events.put(SVGEventsManager.MOUSE_DOWN,
					bundle.getString("item_mouseDown"));
			events.put(SVGEventsManager.MOUSE_UP,
					bundle.getString("item_mouseUp"));
			events.put(SVGEventsManager.CLICK, bundle.getString("item_click"));
			events.put(SVGEventsManager.MOUSE_OVER,
					bundle.getString("item_mouseOver"));
			events.put(SVGEventsManager.MOUSE_OUT,
					bundle.getString("item_mouseOut"));
			events.put(SVGEventsManager.MOUSE_MOVE,
					bundle.getString("item_mouseMove"));
			events.put(SVGEventsManager.KEY_UP, bundle.getString("item_keyUp"));
			events.put(SVGEventsManager.KEY_DOWN,
					bundle.getString("item_keyDown"));
			events.put(SVGEventsManager.KEY_TYPED,
					bundle.getString("item_keyTyped"));
		} catch (Exception ex) {
		}
	...
	protected void buildWidget() {
		...
		if (isEditor) {
			...
			if (Editor.getParent() instanceof Frame) {
				...
				eventChooserDialog = new EventChooserDialog(
						(Frame) Editor.getParent());

			} else if (Editor.getParent() instanceof JDialog) {

				eventChooserDialog = new EventChooserDialog(
						(JDialog) Editor.getParent());
			}
		}
	}
		...
		if (!value.equals("")) {
			...
			for (String itemValue : splitValue) {
				...
				if (itemValue != null) {
					...
					elements.clear();
					innerItemSplitValue = itemValue
							.split(EventItem.elementSeparator);
					...
					if (elements.size() >= 3) {
						...
						// getting the values for the event item corresponding
						// to the current
						// element value
						event = -1;
						modifier = 0;
						...
						if (event != -1) {
							...
							// getting the even item corresponding to the event
							// type
	...
	protected class EventChooserDialog extends TitledDialog {
		...
		protected JPanel buildContentPanel() {
			...
			String messageLabel = bundle
					.getString("rtdaanim_eventchooser_explainLabel");
	...
	protected class EventChooserTable extends JTable {
		...
		public int resizeColumns() {
			...
			getColumnModel().getColumn(0).setPreferredWidth(
					checkBoxTableWidget.getPreferredWidth());
			getColumnModel().getColumn(1).setPreferredWidth(
					jLabelWidget.getPreferredWidth());
			getColumnModel().getColumn(2).setPreferredWidth(
					modifiersListWidget.getPreferredWidth());
			getColumnModel().getColumn(3).setPreferredWidth(
					keyChooserWidget.getPreferredWidth());
		...
		public TableCellRenderer getCellRenderer(int row, int col) {
			...
			if (tableRenderer != null && row < getRowCount()
					&& col < getColumnCount()) {
		...
		protected class EventChooserTableModel extends AbstractTableModel {
			 ...
			 * the column labels
			 */
			protected String usedlabel = "", eventColumnLabel = "",
					modifiersColumnLabel = "", keyColumnLabel = "";
			...
			protected EventChooserTableModel() {
				...
				// getting the labels
				try {
					usedlabel = ResourcesManager.bundle
							.getString("rtdaanim_eventchooser_usedLabel");
					eventColumnLabel = ResourcesManager.bundle
							.getString("rtdaanim_eventchooser_eventLabel");
					modifiersColumnLabel = ResourcesManager.bundle
							.getString("rtdaanim_eventchooser_modifiersLabel");
					keyColumnLabel = ResourcesManager.bundle
							.getString("rtdaanim_eventchooser_keysLabel");
				} catch (Exception ex) {
				}
			}
				...
				if (eventItem != null) {
					...
					switch (column) {
						...
						case 0 :
							...
							checkBoxTableWidget
									.setEventItemForRendering(eventItem);
		 ...
		 * @author ITRIS, Jordi SUC
		 */
		protected class EventChooserTableEditor extends AbstractCellEditor
				implements
					TableCellEditor {
				...
				if (eventItem != null) {
					...
					switch (column) {
						...
						case 0 :
							...
							checkBoxTableWidgetEditor.setEventItemForEditing(
									eventItem, this);
							return checkBoxTableWidgetEditor;

						case 2 :

							modifiersListWidgetEditor.setEventItemForEditing(
									eventItem, this);
							return modifiersListWidgetEditor;

						case 3 :

							keyChooserWidgetEditor.setEventItemForEditing(
									eventItem, this);
		...
		protected class EventChooserWidget extends JComponent {
			 ...
			 *            the table cell editor
			 */
			protected void setEventItemForEditing(EventItem item,
					EventChooserTableEditor tableCellEditor) {
			...
			protected ListSelectionListener listSelectionListener = new ListSelectionListener() {
				...
				public void valueChanged(ListSelectionEvent evt) {
					...
					if (currentEventItem != null && tableCellEditor != null) {
						...
						// computing the integer corresponding to the selected
						// list items
						Object[] selectedValues = modifiersList
								.getSelectedValues();
			...
			protected void setEventItemForRendering(EventItem item) {
				...
				if (item.isUsed()) {
					...
					for (int i = 0; i < modifiersList.getModel().getSize(); i++) {
						...
						listItem = (ComboListItem) modifiersList.getModel()
								.getElementAt(i);
			...
			private ActionListener actionListener = new ActionListener() {
				...
				public void actionPerformed(ActionEvent evt) {
					...
					if (currentEventItem != null && tableCellEditor != null) {
						...
						ComboListItem selectedItem = (ComboListItem) keyCombo
								.getSelectedItem();

						if (selectedItem != null) {

							// Setting the selected key
							currentEventItem.setKey((Integer) selectedItem
									.getValue());
						}
					}
	...
	protected class EventItem {
		 ...
		 * the separators
		 */
		protected static final String elementSeparator = ":",
				itemsSeparator = ";";
		...
		/**
		 * whether the event consists in pressing, releasing or clicking a mouse
		 * button
		 */
		...
		protected EventItem(int eventType) {
			...
			isMouseButtonEvent = (eventType == SVGEventsManager.CLICK
					|| eventType == SVGEventsManager.MOUSE_DOWN || eventType == SVGEventsManager.MOUSE_UP);
		}
		...
		public String toString() {
			...
			return eventType + elementSeparator + getModifiers()
					+ elementSeparator + key;
		}
