...
import com.angrysnail.sheeta.rtdaeditor.anim.widgets.tageventchooser.TagChooser;
...
public class Limit extends Widget {
	...
	protected void buildWidget() {
		...
		autoValueLabel = ResourcesManager.bundle
				.getString("rtdaanim_automatic");
		infinityValueLabel = ResourcesManager.bundle
				.getString("rtdaanim_infiniteValue");
	...
	protected class ChooserDialog extends TitledDialog {
		...
		protected JPanel buildContentPanel() {
			...
			String message = bundle.getString(isChildMode
					? "rtdaanim_selectLimitMessageIsChild"
					: "rtdaanim_selectLimitMessageNotChild");
			String autoLabel = bundle.getString("rtdaanim_automatic");
			String absValueLabel = bundle.getString("rtdaanim_absValue");
			String perCentValueLabel = bundle
					.getString("rtdaanim_perCentValue");
			String infiniteValueLabel = bundle
					.getString("rtdaanim_infiniteValue");
			...
			absSpinner = new DoubleSpinnerWidget(0, -10000000000D, 1000000000D,
					1, false);
		...
		protected void handleComponentsState(String startValue) {
			...
			if (autoRadioButton != null
					&& startValue.equals(DataLimit.AUTO_LIMIT)) {
		...
		public String getValue() {
			...
			if (autoRadioButton != null && autoRadioButton.isSelected()) {
				...
				value = FormatStore.format(absSpinner.getWidgetValue());
					...
					&& perCentRadioButton.isSelected()) {

				value = FormatStore.format(perCentSpinner.getWidgetValue())
						+ "%";

			} else if (infiniteRadioButton != null
					&& infiniteRadioButton.isSelected()) {
