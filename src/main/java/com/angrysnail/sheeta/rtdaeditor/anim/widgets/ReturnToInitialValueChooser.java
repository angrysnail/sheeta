...
public class ReturnToInitialValueChooser extends Widget {
	 ...
	 */
	private final String autoValue = "auto",
			mouseUpEventValue = "mouseUpEvent";
	 ...
	 * the labels
	 */
	private String autoLabel = "", mouseUpEventLabel = "", secondsLabel = "",
			beforeTimerLabel = "";

	/**
	 * whether the chooser should be simple, ie, not using the mouseup event
	 * feature
	 */
	 ...
	 * @param isSimple
	 *            whether the chooser should be simple, ie, not using the
	 *            mouseup event feature
	 */
	...
	protected class ChooserDialog extends TitledDialog {
		 ...
		 * the radio buttons
		 */
		private JRadioButton autoRadioButton, mouseUpEventRadioButton,
				timerRadioButton;
		...
		protected JPanel buildContentPanel() {
			...
			String titleMessage = bundle
					.getString("rtdaanim_ReturnToInitialValueChooserTitle");
			String message = "";

			if (isSimple) {

				message = bundle
						.getString("rtdaanim_ReturnToInitialValueChooserSimpleMessage");

			} else {

				message = bundle
						.getString("rtdaanim_ReturnToInitialValueChooserMessage");
			}
