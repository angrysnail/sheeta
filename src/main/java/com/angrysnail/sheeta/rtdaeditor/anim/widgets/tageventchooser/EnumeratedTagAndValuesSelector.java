...
public class EnumeratedTagAndValuesSelector extends JPanel {
	 ...
	 *            the radio button
	 */
	public EnumeratedTagAndValuesSelector(TagEventChooser tagEventChooser,
	...
	protected void build() {
		...
		String tagValuesLabel = ResourcesManager.bundle
				.getString("rtdaanim_tagValuesCondition");
		...
		ActionListener tagChooserListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				initList(tagChooserWidget.getCurrentValue(),
		...
		// creating the list that will contain all the possible values of the
		// selected tag
	 ...
	 *            a tag name
	 * @param values
	 *            the list of the selected values of the tag
	 */
	protected void initList(String tagName, LinkedList<String> values) {
		...
		if (tagName != null && !tagName.equals("")) {
			...
			LinkedList<String> tagValues = DataBaseNodeToolkit
					.getEnumeratedTagValues(tagEventChooser.getItem()
							.getDocument(), tagName);
	...
	protected String getValue() {
		...
		value = TagEventsManager.separator + tagValue
