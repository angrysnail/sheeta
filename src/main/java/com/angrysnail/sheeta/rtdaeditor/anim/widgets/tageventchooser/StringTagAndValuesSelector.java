...
public class StringTagAndValuesSelector extends JPanel {
	 ...
	 *            the radio button
	 */
	public StringTagAndValuesSelector(TagEventChooser tagEventChooser,
	...
	protected void build() {
		...
		String tagValuesLabel = ResourcesManager.bundle
				.getString("rtdaanim_tagStringValueCondition");
	...
	protected String getValue() {
		...
		value = TagEventsManager.stringKeyword + TagEventsManager.separator
