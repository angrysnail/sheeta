...
public class TagEventChooser extends Widget {
	...
	/**
	 * the class of the dialog used to choose the tag and the conditions that
	 * will defines the tag event
	 * 
	 * @author ITRIS, Jordi SUC
	 */
	protected class ChooserDialog extends TitledDialog {
		 ...
		 * the radio buttons
		 */
		protected JRadioButton enumRadioButton, analogRadioButton,
				stringRadioButton;
		...
		protected JPanel buildContentPanel() {
			...
			String titleMessage = bundle
					.getString("rtdaanim_tageventchoosertitle");
