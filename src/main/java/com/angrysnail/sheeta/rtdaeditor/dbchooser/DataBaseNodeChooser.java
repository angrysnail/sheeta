...
public class DataBaseNodeChooser extends TitledDialog {
	...
	protected void buildRemaining() {
		...
		chooserPanel = new DataBaseNodeChooserPanel(document, filter,
				showViewNodes, showClosePopupDialogNode);
		...
		DataBaseNodeChooserStateListener listener = new DataBaseNodeChooserStateListener() {
	...
	protected JPanel buildContentPanel() {
		...
		String dialogTitleLabel = bundle
				.getString("rtdaanim_tagchooserdialogtitle");
	...
	protected String getComment() {
		...
		// getting the labels
		ResourceBundle bundle = ResourcesManager.bundle;
		String commentStart = bundle
				.getString("rtdaanim_tagchoosercommentstart");
		String commentEnumeratedTag = bundle
				.getString("rtdaanim_tagchoosercommentenumeratedtag");
		String commentFloatTag = bundle
				.getString("rtdaanim_tagchoosercommentfloattag");
		String commentIntegerTag = bundle
				.getString("rtdaanim_tagchoosercommentintegertag");
		String commentAnalogicTag = bundle
				.getString("rtdaanim_tagchoosercommentanalogictag");
		String commentStringTag = bundle
				.getString("rtdaanim_tagchoosercommentstringtag");
		String commentView = bundle.getString("rtdaanim_tagchoosercommentview");
		String commentNotATag = bundle
				.getString("rtdaanim_tagchoosercommentdefault");
	 ...
	 */
	public static DataBaseNodeChooser getDataBaseNodeChooser(Container parent,
			Document document, DataBaseNodeFilter filter,
			boolean showViewNodes, boolean showClosePopupDialogNode) {

		if (parent instanceof Frame) {

			return new DataBaseNodeChooser((Frame) parent, document, filter,
					showViewNodes, showClosePopupDialogNode);

		} else {

			return new DataBaseNodeChooser((JDialog) parent, document, filter,
					showViewNodes, showClosePopupDialogNode);
		}
	}
}
