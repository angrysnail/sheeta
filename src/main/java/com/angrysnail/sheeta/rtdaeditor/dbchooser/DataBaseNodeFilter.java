...
public class DataBaseNodeFilter {
	...
	/**
	 * whether or not the only nodes that can be displayed are those who are at
	 * the last level
	 */
	 ...
	 *            the split tag name string
	 * @param level
	 *            the level at which the nodes that could be selected should be
	 *            found
	 * @param tagType
	 *            the type of node to be chosen
	 * @param strictEquality
	 *            whether two tag types should be compared with a strict
	 *            equality or not
	 * @param showOnlyThisLevel
	 *            whether or not the only nodes that can be displayed are those
	 *            who are at the last level
	 * @param excludedViewPath
	 *            the path of the view that should be excluded from the view
	 *            chooser
	 */
	public DataBaseNodeFilter(String tagName, int level, int tagType,
			boolean strictEquality, boolean showOnlyThisLevel,
	...
	/**
	 * @return whether or not the only nodes that can be displayed are those who
	 *         are at the last level
	 */
	...
	/**
	 * @return whether two tag types should be compared with a strict equality
	 *         or not
	 */
