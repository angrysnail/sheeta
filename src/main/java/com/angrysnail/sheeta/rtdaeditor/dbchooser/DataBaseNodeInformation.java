...
public class DataBaseNodeInformation {
	...
	/**
	 * the list of the enumerated values of a tag if this tag is an enumerated
	 * one
	 */
	 ...
	 *            the list of the enumerated values of a tag if this tag is an
	 *            enumerated one
	 * @param viewLocation
	 *            the location of a view if this node corresponds to a view
	 */
	public DataBaseNodeInformation(int tagType, String xmlPath,
			LinkedList<String> enumeratedValues, String viewLocation) {
