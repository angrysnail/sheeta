 ...
 */
public class InsertedWidgetDataBaseModel extends DefaultTreeModel
		implements
			TreeModel {
	 ...
	 */
	public InsertedWidgetDataBaseModel(DataBaseEditorModule dbEditor,
			JTree tree, Element rootModel) {
		...
		if (rootModel != null) {
			...
			rootNode = new InsertedWidgetDataBaseEditorTreeNode(dbEditor, this,
					rootModel);
			setRoot(rootNode);
		}
	}
