...
import com.angrysnail.sheeta.rtdaeditor.anim.components.AnimationsChooser;
...
public abstract class AnimationChooserJWidgetSourceChooser extends JComponent {
	 ...
	 * 
	 * @param animationsChooser
	 *            the animationsChooser to set
	 * @param jwidgetElement
	 *            a jwidget element
	 */
	public void setInitialSource(AnimationsChooser animationsChooser,
