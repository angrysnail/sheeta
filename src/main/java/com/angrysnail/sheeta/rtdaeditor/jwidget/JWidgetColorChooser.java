...
public class JWidgetColorChooser extends JButton {
	...
	protected void paintComponent(Graphics g) {
		...
		if (currentColor != null) {
			...
			g.fillRect(diff, diff, prefSize.width - 2 * diff, prefSize.height
					- 2 * diff);
		}
	}
	 ...
	 * 
	 * @param listener
	 *            a new action listener to the component
	 */
	 ...
	 * 
	 * @param listener
	 *            an action listener to the component
	 */
	...
	protected void notifyChanges() {
		...
		for (ActionListener listener : new HashSet<ActionListener>(
				actionListeners)) {
