...
public class TestTableModel extends AbstractTableModel {
	 ...
	 */
	public static String[] columnIds = {"name", "value", "min", "max", "type",
			"period", "initialValue"};

	/**
	 * the labels for the names of the columns
	 */
	private String nameLabel = "", valueLabel = "", minLabel = "",
			maxLabel = "", periodLabel = "", initialValueLabel = "",
			typeLabel = "";
		...
		if (row < getRowCount() && col < getColumnCount()) {
			...
			if (testValues != null) {
				...
				if (columnIds[col].equals("name")) {
					...
					if ((testValues.getTagType() == TagToolkit.ANALOGIC_FLOAT || testValues
							.getTagType() == TagToolkit.ANALOGIC_INTEGER)) {
