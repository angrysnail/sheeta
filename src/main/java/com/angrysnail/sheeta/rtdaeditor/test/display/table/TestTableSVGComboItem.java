...
public class TestTableSVGComboItem {
	...
	/**
	 * the object describing the variables that should be modified to simulate
	 * the animations
	 */
	 ...
	 *            the index of a column
	 * @param testValues
	 *            the object describing the variables that should be modified to
	 *            simulate the animations
	 */
	public TestTableSVGComboItem(String value, String label, int columnIndex,
