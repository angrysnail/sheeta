package com.angrysnail.sheeta.rtdaeditor.widget;
...
import com.angrysnail.sheeta.library.widgets.Widget;
...
public class FontStyleChooser extends Widget {
	 ...
	 * 
	 * @param initValues
	 *            an array of five strings containing the values for the
	 *            following fields: {font color, font family, font size, bold,
	 *            italic};
	 */
	...
	protected void build() {
		...
		// getting the labels
		String fontBorderLabel = ResourcesManager.bundle
				.getString("FontSizeChooserBorderLabel");
		String colorLabel = ResourcesManager.bundle
				.getString("FontSizeChooserColorLabel");
		String familyLabel = ResourcesManager.bundle
				.getString("FontSizeChooserFamilyLabel");
		String sizeLabel = ResourcesManager.bundle
				.getString("FontSizeChooserSizeLabel");
		String boldLabel = ResourcesManager.bundle
				.getString("FontSizeChooserBoldLabel");
		String italicLabel = ResourcesManager.bundle
				.getString("FontSizeChooserItalicLabel");
