...
public class DOMViewer extends JFrame implements ActionMap {
	 ...
	 */
	protected final static String RESOURCE = "com.angrysnail.sheeta.svgeditor.resources.DOMViewerMessages";
				...
				if (nodeInfo instanceof NodeInfo) {
					...
					switch (node.getNodeType()) {
						...
						case Node.ELEMENT_NODE :
							attributesTable.setModel(new NodeAttributesModel(
									node));
							propertiesTable.setModel(new NodeCSSValuesModel(
									node));
