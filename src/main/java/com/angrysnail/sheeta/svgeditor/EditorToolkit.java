...
public class EditorToolkit {
	...
	static {
		...
		svgElementLabels.put("g",
				ResourcesManager.bundle.getString("svgElementName_g"));
		svgElementLabels.put("ellipse",
				ResourcesManager.bundle.getString("svgElementName_ellipse"));
		svgElementLabels.put("image",
				ResourcesManager.bundle.getString("svgElementName_image"));
		svgElementLabels.put("path",
				ResourcesManager.bundle.getString("svgElementName_path"));
		svgElementLabels.put("rect",
				ResourcesManager.bundle.getString("svgElementName_rect"));
		svgElementLabels.put("text",
				ResourcesManager.bundle.getString("svgElementName_text"));
	...
	public static Rectangle2D getComputedRectangle(Point2D point1,
		...
		if (point1 != null && point2 != null) {
			...
			double width = point2.getX() - point1.getX(), height = point2
					.getY() - point1.getY(), x = point1.getX(), y = point1
					.getY();
