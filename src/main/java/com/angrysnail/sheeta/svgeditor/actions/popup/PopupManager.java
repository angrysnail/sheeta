...
Contact : jordi.suc@itris.fr; philippe.gil@itris.fr
 ...
 =============================================
 */
package com.angrysnail.sheeta.svgeditor.actions.popup;
	...
	public void showPopup(SVGHandle handle, Point location) {
		...
		if (handle != null && location != null && popupMenu != null) {
			...
			if (popupItems != null && popupItems.size() > 0) {
				...
				// for each group of menu items, fills the pop up menu and put
				// popup
				...
				for (LinkedList<String> itemNames : popupItemsDescription
					...
					if (itemNames != null) {
						...
						for (String itemName : itemNames) {
							...
							// if the name of the menuitem of the popup model is
							// contained
							// in the list of the names of the menuitems that
							// should be displayed
							if (itemName != null
						...
						if (isGroupEnabled) {
							...
							if (hasAddedAnItem
									&& i < popupItemsDescription.size() - 1) {

								// if other groups of menu items could be added
								// and if menu items
								// from the previous group have been added, a
