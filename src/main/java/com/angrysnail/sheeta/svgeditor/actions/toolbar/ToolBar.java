...
public class ToolBar {
	 ...
	 * 
	 * @param toolItems
	 *            the map of all the tool items that exist in the application
	 * @param element
	 *            a dom element describing the tool bar
	 */
	...
	/**
	 * builds the toolbar given all the tool items of the application and the
	 * dom element describing this toolbar
	 * 
	 * @param toolItems
	 *            the map of all the tool items that exist in the application
	 * @param element
	...
	protected void build(Map<String, AbstractButton> toolItems, Element element) {
		...
		try {
			isExclusive = Boolean.parseBoolean(element
					.getAttribute(exclusiveAtt));
		} catch (Exception ex) {
		}
