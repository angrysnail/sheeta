...
public class ColorChooser extends JColorChooser {
	...
	public ColorChooser(Editor editor) {
		...
		SVGW3CColorChooserPanel w3cColorChooserPanel = new SVGW3CColorChooserPanel(
				editor);
		...
		try {
			...
			w3cSVGColorFlavor = new DataFlavor(
					DataFlavor.javaJVMLocalObjectMimeType
							+ ";class=com.angrysnail.sheeta.svgeditor.colorchooser.SVGW3CColor");
		} catch (Exception ex) {
	...
	public Color showColorChooserDialog(Color initialColor) {
		...
		JDialog dialog = createDialog(Editor.getParent(), "", true, this, ok,
				null);
