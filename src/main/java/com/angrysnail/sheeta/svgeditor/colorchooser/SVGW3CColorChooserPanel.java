...
Contact : jordi.suc@itris.fr; philippe.gil@itris.fr
 ...
 =============================================
 */
package com.angrysnail.sheeta.svgeditor.colorchooser;
...
import com.angrysnail.sheeta.library.color.SVGW3CColor;
...
public class SVGW3CColorChooserPanel extends AbstractColorChooserPanel {
	...
	protected void buildChooser() {
		...
		java.util.List<SVGW3CColor> colorsList = SVGColorsManager
				.getW3CColors();

		colorsPanel.setLayout(new GridLayout((int) (Math.floor(colorsList
				.size() / colorsNbPerLine) + 1), colorsNbPerLine, 1, 1));
		JPanel panel = null;
						...
						for (int i = 0; i < lastColorPanels.size(); i++) {
							...
							if (thePanel != null) {
								...
								if (i < lastSelectedColors.size()) {
									...
									theColor = (SVGW3CColor) lastSelectedColors
											.get(i);
		...
		colorLabelPanel.setBorder(new CompoundBorder(new EmptyBorder(1, 10, 1,
				10), new SoftBevelBorder(BevelBorder.LOWERED)));
