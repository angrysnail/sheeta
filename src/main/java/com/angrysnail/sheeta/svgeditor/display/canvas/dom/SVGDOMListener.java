...
public abstract class SVGDOMListener {
	...
	/**
	 * @param handle
	 *            the handle linked to this listener
	 */
	...
	public void removeListener() {
		...
		if (handleRef != null) {
			...
			handleRef.get().getSvgDOMListenerManager().removeDOMListener(this);
			handleRef = null;
			nodeRef = null;
		}
	}
	...
	/**
	 * notifies that the given node has been inserted under the node of the
	 * listener
	 * 
	 * @param insertedNode
	 *            a node
	...
	/**
	 * notifies that the given node has been removed from the node of the
	 * listener
	 * 
	 * @param removedNode
	 *            a node
	...
	/**
	 * notifies that the sub tree from which the root can been found has been
	 * modified
	 * 
