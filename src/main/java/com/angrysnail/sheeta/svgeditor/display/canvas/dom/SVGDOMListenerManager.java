...
public class SVGDOMListenerManager {
	 ...
	 */
	private ConcurrentHashMap<Node, Set<SVGDOMListener>> domListeners = new ConcurrentHashMap<Node, Set<SVGDOMListener>>();
	...
	/**
	 * adding a listener to the svg dom of this handle (should be invoked in the
	 * AWT THREAD)
	 * 
	 * @param listener
	 *            a listener
	...
	/**
	 * removing a listener from the svg dom of this handle (should be invoked in
	 * the AWT THREAD)
	 * 
	 * @param listener
	 *            a listener
	...
	public void removeDOMListener(SVGDOMListener listener) {
		...
		if (listener != null && listener.getNode() != null
				&& domListeners.containsKey(listener.getNode())) {
	...
	/**
	 * fires that the given node has been modified ( one of its attributes has
	 * been modified) (should be invoked in the AWT THREAD)
	 * 
	 * @param node
	 *            a node
	 */
	...
	/**
	 * fires that the given node has been removed (should be invoked in the AWT
	 * THREAD)
	 * 
	 * @param node
	 *            a node
	...
	/**
	 * fires that the given node has been inserted (should be invoked in the AWT
	 * THREAD)
	 * 
	 * @param node
	 *            a node
	 * @param nodeInserted
	 *            the node that has been inserted into the node children
	 */
	...
	/**
	 * fires that the given sub tree has been modified (should be invoked in the
	 * AWT THREAD)
	 * 
	 * @param rootNode
	 *            a node
	 * @param lastModifiedNode
	 *            the last node that has been modified
	 */
	public void fireStructureChanged(Node rootNode, Node lastModifiedNode) {
