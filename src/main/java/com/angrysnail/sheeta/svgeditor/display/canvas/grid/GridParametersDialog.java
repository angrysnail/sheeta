package com.angrysnail.sheeta.svgeditor.display.canvas.grid;
...
public class GridParametersDialog extends TitledDialog {
	 ...
	 * 
	 * @param gridParametersHandler
	 *            the grid parameters handler
	 * @param parent
	 *            the parent frame
	 */
	public GridParametersDialog(GridParametersManager gridParametersHandler,
			Frame parent) {
	...
	protected JPanel buildContentPanel() {
		...
		// getting the labels
		String gridDialogTitleLabel = ResourcesManager.bundle
				.getString("GridDialogTitle");
		String gridDialogMessageLabel = ResourcesManager.bundle
				.getString("GridDialogMessage");
		String gridColorLabel = ResourcesManager.bundle.getString("GridColor");
		String lineStyleLabel = ResourcesManager.bundle
				.getString("GridLineStyle");
		String distanceLabel = ResourcesManager.bundle
				.getString("GridDistance");
		String horizontalDistanceLabel = ResourcesManager.bundle
				.getString("GridHorizontalDistance");
		String verticalDistanceLabel = ResourcesManager.bundle
				.getString("GridVerticalDistance");
		...
		// creating the jlabels
		JLabel horizontalDistanceLbl = new JLabel(horizontalDistanceLabel
				+ " : ");
		horizontalDistanceLbl.setHorizontalAlignment(SwingConstants.RIGHT);
		JLabel hPxLbl = new JLabel(pxLabel);
		JLabel verticalDistanceLbl = new JLabel(verticalDistanceLabel + " : ");
		verticalDistanceLbl.setHorizontalAlignment(SwingConstants.RIGHT);
		JLabel vPxLbl = new JLabel(pxLabel);

		// creating the widgets
		horizontalSpinner = new DoubleSpinnerWidget(1, 1, 1000000000000D, 1,
				false);
		verticalSpinner = new DoubleSpinnerWidget(1, 1, 1000000000000D, 1,
				false);
