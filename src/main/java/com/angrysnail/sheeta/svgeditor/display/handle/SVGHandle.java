 ...
 * 
 ...
 =============================================
 */
package com.angrysnail.sheeta.svgeditor.display.handle;
...
import com.angrysnail.sheeta.svgeditor.display.canvas.SVGFrame;
import com.angrysnail.sheeta.svgeditor.display.canvas.SVGScrollPane;
import com.angrysnail.sheeta.svgeditor.display.canvas.dom.SVGDOMListenerManager;
import com.angrysnail.sheeta.svgeditor.display.canvas.dom.SVGDOMNormalizer;
import com.angrysnail.sheeta.svgeditor.display.handle.manager.SVGElementsManager;
import com.angrysnail.sheeta.svgeditor.display.handle.manager.SVGResourcesManager;
import com.angrysnail.sheeta.svgeditor.display.handle.manager.TransformsManager;
import com.angrysnail.sheeta.svgeditor.display.selection.Selection;
import com.angrysnail.sheeta.svgeditor.display.undoredo.UndoRedo;
	...
	public Color pickColor(Point point) {
		...
		if (point != null) {
			...
			if (pos != 0) {
				...
				color = new Color(model.getRed(pos), model.getGreen(pos),
						model.getBlue(pos));
			}
		}
