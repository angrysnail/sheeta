...
/**
 * @author ITRIS, Jordi SUC the class of the list of SVGUndoRedoActions
 */
public class UndoRedoActionList extends LinkedList<UndoRedoAction> {
	...
	/**
	 * @return whether the calling method is not executed in the AWT thread. It
	 *         implies that the provided runnables should be executed in the AWT
	 *         thread
	 */
