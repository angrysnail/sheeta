...
import com.angrysnail.sheeta.library.util.XMLPrinter;
...
import com.angrysnail.sheeta.svgeditor.io.managers.monitor.SaveMonitor;
	...
	public FileSave(IOManager ioManager) {
		...
		if (Editor.getParent() instanceof Frame) {
			...
			fileChooserDialog = new FileChooserDialog(
					...
					FileChooserDialog.SAVE_FILE_MODE);
	...
	public boolean saveHandleDocument(SVGHandle handle, boolean saveAs,
		...
		if (handleFile == null || saveAs) {
			...
			if (selectedFile != null) {
				...
				Monitor monitor = new SaveMonitor(Editor.getParent(),
