package com.angrysnail.sheeta.svgeditor.io.managers.export;
...
import com.angrysnail.sheeta.svgeditor.io.managers.dialog.ExportFileFilter;
import com.angrysnail.sheeta.svgeditor.io.managers.dialog.FileChooserDialog;
import com.angrysnail.sheeta.svgeditor.io.managers.export.handler.Export;
		...
		for (int i = 0; i < formats.length; i++) {
			...
			if (Editor.getParent() instanceof Frame) {
				...
				fileChooserDialogs[i] = new FileChooserDialog(
						...
						FileChooserDialog.EXPORT_FILE_MODE);
