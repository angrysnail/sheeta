...
/**
 * the class of the dialog used to choose the parameters of the jpg export
 * action
 * 
	...
	protected void initialize() {
		...
		if (bundle != null) {
			...
			try {
				...
				jpgCompressionSettingsLabel = bundle
						.getString("labeljpegcompressionsettings");
		...
		compressionSettingsPanel.setBorder(new TitledBorder(
				jpgCompressionSettingsLabel));
