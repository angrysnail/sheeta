...
/**
 * the class of the dialog used to choose the parameters of the png export
 * action
 * 
...
public class PNGExportDialog extends ExportDialog {
	 ...
	 * the labels
	 */
	private String compressionLevelLabel = "", encodeAlphaLabel = "",
			imageSettingsLabel = "";
	...
	protected void initialize() {
		...
		if (bundle != null) {
			...
			try {
				...
				compressionLevelLabel = bundle
						.getString("labelpngCompressionLevel");
		...
		compressionPanel.setBorder(new CompoundBorder(new TitledBorder(
				imageSettingsLabel), new EmptyBorder(4, 4, 4, 4)));
