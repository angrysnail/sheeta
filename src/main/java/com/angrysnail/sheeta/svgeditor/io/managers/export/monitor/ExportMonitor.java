package com.angrysnail.sheeta.svgeditor.io.managers.export.monitor;
...
public class ExportMonitor extends Monitor {
	...
	protected void initialize() {
		...
		titleLabel = ResourcesManager.bundle
				.getString("FileExportMonitorTitle");
		messageLabel = ResourcesManager.bundle.getString(exportPrefix
				+ "ExportMonitorMessage");
