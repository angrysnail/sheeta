...
public class OpenMonitor extends Monitor {
	 ...
	 * 
	 * @param file
	 *            the file whose loading is monitored
	 * @param parent
	...
	protected void initialize() {
		...
		documentLoadingLabel = ResourcesManager.bundle
				.getString("OpenMonitorDocumentLoading");
		imageBuildingLabel = ResourcesManager.bundle
				.getString("OpenMonitorImageBuilding");
		imageRenderingLabel = ResourcesManager.bundle
				.getString("OpenMonitorImageRendering");
