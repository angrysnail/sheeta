...
public class ClosePathModeManager {
	...
	protected void initializeParameters() {
		...
		try {
			shouldClosePath = Boolean.parseBoolean(PreferencesStore
					.getPreference(null, MODE_PREF_ID));
		} catch (Exception ex) {
			shouldClosePath = defaultShouldClosePathEnabled;
		}
	}
	...
	protected void updatePreferences() {
		...
		PreferencesStore.setPreference(null, MODE_PREF_ID,
				Boolean.toString(shouldClosePath));
	}
