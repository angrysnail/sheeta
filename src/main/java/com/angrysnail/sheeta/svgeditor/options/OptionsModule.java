package com.angrysnail.sheeta.svgeditor.options;
...
public class OptionsModule extends ModuleAdapter {
	...
	protected String[] ids = {"RemanentMode", "SquareMode",
			"AlignWithRulersMode", "ClosePathMode", "ConstraintLinesMode"};
	...
	protected void initializeItemsState() {
		...
		optionsMenuItems[0].setSelected(Editor.getEditor()
				.getRemanentModeManager().isRemanentMode());
		optionsMenuItems[1].setSelected(Editor.getEditor()
				.getSquareModeManager().isSquareMode());
		optionsMenuItems[2].setSelected(Editor.getEditor().getHandlesManager()
				.getRulersParametersHandler().alignWithRulers());
		optionsMenuItems[3].setSelected(Editor.getEditor()
				.getClosePathModeManager().shouldClosePath());
		optionsMenuItems[4].setSelected(Editor.getEditor()
				.getConstraintLinesModeManager().constraintLines());

		optionsToolItems[0].setSelected(Editor.getEditor()
				.getRemanentModeManager().isRemanentMode());
		optionsToolItems[1].setSelected(Editor.getEditor()
				.getSquareModeManager().isSquareMode());
		optionsToolItems[2].setSelected(Editor.getEditor().getHandlesManager()
				.getRulersParametersHandler().alignWithRulers());
		optionsToolItems[3].setSelected(Editor.getEditor()
				.getClosePathModeManager().shouldClosePath());
		optionsToolItems[4].setSelected(Editor.getEditor()
				.getConstraintLinesModeManager().constraintLines());
	}
