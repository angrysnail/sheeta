...
public class RemanentModeManager {
	...
	protected void initializeParameters() {
		...
		try {
			isRemanentMode = Boolean.parseBoolean(PreferencesStore
					.getPreference(null, MODE_PREF_ID));
		} catch (Exception ex) {
			isRemanentMode = defaultIsRemanentEnabled;
		}
	}
	...
	protected void updatePreferences() {
		...
		PreferencesStore.setPreference(null, MODE_PREF_ID,
				Boolean.toString(isRemanentMode));
	}
	 ...
	 * 
	 * @param isRemanentMode
	 *            the new remanent mode
	 */
