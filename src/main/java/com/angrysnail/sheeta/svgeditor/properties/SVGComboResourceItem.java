...
public class SVGComboResourceItem {
	 ...
	 *            the resource node
	 */
	public SVGComboResourceItem(SVGHandle handle, String value, String label,
			Element resource) {
		...
		if (resource != null) {
			...
			resourceImage = Editor
					.getEditor()
					.getResourceImageManager()
					.getResourceRepresentation(handle,
							resource.getAttribute("id"), true, null);
