...
public class SVGPropertiesEditableComboWidget extends SVGPropertiesWidget {
	...
	protected void buildComponent() {
		...
		String cur = null, propertyValue = propertyItem
				.getGeneralPropertyValue();

		// builds the array of items for the combo
		for (Iterator it = propertyItem.getPropertyValuesMap().keySet()
				.iterator(); it.hasNext();) {

			try {
				cur = (String) it.next();
				String value = (String) propertyItem.getPropertyValuesMap()
						.get(cur);
				item = new SVGPropertiesComboItem(value, (String) propertyItem
						.getPropertyValuesLabelMap().get(cur));
		...
		if (selectedItem == null && propertyValue != null) {
			...
			selectedItem = new SVGPropertiesComboItem(propertyValue,
					propertyValue);
		...
		final ActionListener comboListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (combo.getSelectedItem() != null) {
					...
					try {
						value = ((SVGPropertiesComboItem) combo
