...
public class SVGPropertiesFontChooserWidget extends SVGPropertiesWidget {
	...
	protected void buildComponent() {
		...
		combo.setSelectedItem(fontFamilyList.contains(propertyValue)
				? new Integer(fontFamilyList.indexOf(propertyValue))
				: new Integer(0));
		...
		final ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (combo.getSelectedItem() != null) {
					...
					try {
						value = (String) (fontFamilyList.get(((Integer) combo
	 ...
	 * @author ITRIS, Jordi SUC
	 */
	protected class FontFamilyRenderer extends JLabel
			implements
				ListCellRenderer {
