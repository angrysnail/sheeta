	...
	static {
		...
		try {
			bundle = ResourceBundle
					.getBundle("com.angrysnail.sheeta.svgeditor.resources.properties.SVGEditorStrings");
		} catch (Exception ex) {
			bundle = null;
		}
	}
			...
			if (icons.containsKey(name)) {
				...
				try {
					iconsBundle = ResourceBundle
							.getBundle("com.angrysnail.sheeta.svgeditor.resources.properties.SVGEditorIcons");
				} catch (Exception ex) {
				}
