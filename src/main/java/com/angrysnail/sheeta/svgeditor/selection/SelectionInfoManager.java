...
public class SelectionInfoManager {
	 ...
	 */
	private com.angrysnail.sheeta.svgeditor.shape.AbstractShape drawingShape;
	...
	public void setSelectionMode(int selectionMode,
			com.angrysnail.sheeta.svgeditor.shape.AbstractShape drawingShape) {
		...
		// mode
		Set<SVGHandle> handles = new HashSet<SVGHandle>(Editor.getEditor()
	 ...
	 */
	public com.angrysnail.sheeta.svgeditor.shape.AbstractShape getDrawingShape() {
		return drawingShape;
	}
