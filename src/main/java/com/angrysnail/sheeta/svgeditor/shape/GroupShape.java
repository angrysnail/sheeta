...
public class GroupShape extends MultiAbstractShape {
	...
	public Collection<PopupItem> getPopupItems() {
		...
		PopupItem groupItem = new PopupItem(Editor.getEditor(), shapeModuleId,
			...
			public JMenuItem getPopupItem(LinkedList<Element> nodes) {
				...
				SVGHandle currentHandle = Editor.getEditor()
		...
		// creating the group popup item
		PopupItem unGroupItem = new PopupItem(Editor.getEditor(), unGroupId,
					...
					if (selectedElements.contains(element)) {
						...
						if (previousElement != null) {
							...
							parentNode.insertBefore(element,
									previousElement.getNextSibling());
