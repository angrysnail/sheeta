...
import com.angrysnail.sheeta.library.display.ArrowIcon;
...
public class PathShapeItemsHandler {
	...
	protected ImageIcon shapeCreatorIcon, shapeCreatorDisabledIcon,
			addPointIcon, addPointDisabledIcon, removePointIcon,
			removePointDisabledIcon;
	 ...
	 */
	protected JMenuItem shapeCreatorMenuItem, addPointMenuItem,
			removePointMenuItem;
	...
	protected void createItems() {
		...
		removePointDisabledIcon = ResourcesManager.getIcon("RemovePointPath",
				true);
		...
		itemTooltip = ResourcesManager.bundle.getString(shapeModuleId
				+ "ItemToolTip");
		addPointLabel = ResourcesManager.bundle.getString(shapeModuleId
				+ "AddPointLabel");
		addPointTooltip = ResourcesManager.bundle.getString(shapeModuleId
				+ "AddPointToolTip");
		removePointLabel = ResourcesManager.bundle.getString(shapeModuleId
				+ "RemovePointLabel");
		removePointTooltip = ResourcesManager.bundle.getString(shapeModuleId
				+ "RemovePointToolTip");
		...
		toolButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent evt) {
				...
				// setting the global module mode to the current mode of the
				// tool
