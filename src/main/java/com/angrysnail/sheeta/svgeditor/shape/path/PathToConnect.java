...
/**
 * the class defining the element to which a new path should be connected
 * 
 * @author Jordi SUC
 */
public class PathToConnect {
	 ...
	 *            the element
	 * @param itemIndex
	 *            the index of the item defining where the new path should be
	 *            inserted
	 */
	...
	/**
	 * @return whether the action this object denotes consists in inserting a
	 *         path before the current one or after the current one
	 */
