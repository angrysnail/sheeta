 ...
 * enabling to modify the properties (with an editable combo) of an attribute
 * (or a group of attributes) of a resource node.
 * 
 * @author ITRIS, Jordi SUC
 */
public class SVGVisualResourceEditableComboAttributeWidget
		extends
	 ...
	 */
	public SVGVisualResourceEditableComboAttributeWidget(
	...
	protected void buildComponent() {
		...
		if (resourceObjectAttribute != null) {
			...
			if (selectedItem == null
					&& resourceObjectAttribute.getValue() != null) {

				selectedItem = new SVGComboItem(
						resourceObjectAttribute.getValue(),
						resourceObjectAttribute.getValue());
