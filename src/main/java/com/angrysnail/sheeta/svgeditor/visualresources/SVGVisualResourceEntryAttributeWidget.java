 ...
 * enabling to modify the properties (with a entry) of an attribute (or a group
 * of attributes) of a resource node.
 * 
 * @author ITRIS, Jordi SUC
 */
public class SVGVisualResourceEntryAttributeWidget
		extends
	 ...
	 */
	public SVGVisualResourceEntryAttributeWidget(
