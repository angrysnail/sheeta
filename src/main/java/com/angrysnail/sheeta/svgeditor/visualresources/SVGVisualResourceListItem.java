...
public class SVGVisualResourceListItem {
	 ...
	 *            a resource object
	 */
	public SVGVisualResourceListItem(SVGHandle handle,
			SVGVisualResourceObject resObj) {
	...
	protected JPanel getResourceRepresentation(Component componentToRefresh) {
		...
		return resImgManager.getResourceRepresentation(handle,
				resObj.getResourceId(), false, componentToRefresh);
	}
