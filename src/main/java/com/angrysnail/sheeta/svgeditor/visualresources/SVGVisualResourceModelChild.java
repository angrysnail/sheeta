...
public class SVGVisualResourceModelChild {
	 ...
	 *            the visual resources module
	 * @param childElement
	 *            the node describing the child elements of a resource
	 */
	public SVGVisualResourceModelChild(SVGVisualResources visualResources,
		...
		if (childElement != null) {
			...
			// the name of the child
			name = visualResources.getNormalizedString(childElement
					.getAttribute("name"));
			...
			for (Node cur = childElement.getFirstChild(); cur != null; cur = cur
					.getNextSibling()) {

				if (cur instanceof Element) {

					attr = new SVGVisualResourceModelAttribute(visualResources,
							(Element) cur);
					attributes.add(attr);
				}
			}
	 ...
	 */
	protected SVGVisualResourceObjectChild createVisualResourceObjectChild(
			Element element) {
		...
		if (element != null) {
			...
			resObjChild = new SVGVisualResourceObjectChild(element, this,
					resObjAttrList);
		}
