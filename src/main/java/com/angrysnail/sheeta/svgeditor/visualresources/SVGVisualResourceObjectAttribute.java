...
public class SVGVisualResourceObjectAttribute {
	 ...
	 *            the list of the attributes contained in this node, if this is
	 *            a group attribute
	 */
	public SVGVisualResourceObjectAttribute(Node attributeNode,
			SVGVisualResourceModelAttribute attributeModel,
			LinkedList groupAttributes) {
	...
	/**
	 * modifies the attribute nodes and the group attributes (if they exist)
	...
	protected void applyChanges() {
		...
		// modifies the value of the attribute nodes of the group attributes (if
		// they exist)
