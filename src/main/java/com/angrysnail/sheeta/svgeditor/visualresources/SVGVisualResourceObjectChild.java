...
/**
 * the class containing the values of the attributes of a child of a svg
 * resource node
 * 
...
public class SVGVisualResourceObjectChild {
	 ...
	 * 
	 * @param childElement
	 *            a child of the node of the resource in the svg document
	 * @param childModel
	 *            the model of this child
	 * @param attributes
	 *            the list of the attributes
	 */
	public SVGVisualResourceObjectChild(Element childElement,
			SVGVisualResourceModelChild childModel, LinkedList attributes) {
