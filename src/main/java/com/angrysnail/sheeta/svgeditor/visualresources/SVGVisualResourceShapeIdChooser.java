...
public class SVGVisualResourceShapeIdChooser {
	 ...
	 * the labels
	 */
	private static String titleLabel = "", titledBorderLabel = "",
			okLabel = "", cancelLabel = "", alertMessage = "", errorTitle = "";
	...
	static {
		...
		if (bundle != null) {
			...
			try {
				...
				titledBorderLabel = bundle
						.getString("vresource_displaywindowchooserforshapeid");
	...
	public static String showShapeChooserIdDialog(SVGHandle handle) {
		...
		if (handle != null) {
			...
			LinkedList nodesIds = handle.getSvgElementsManager()
					.getShapeNodesIds();
			...
			final ActionListener comboListener = new ActionListener() {
				...
				public void actionPerformed(ActionEvent evt) {
					...
					if (combo.getSelectedItem() != null) {
						...
						value = ((SVGComboItem) combo.getSelectedItem())
								.getValue();
					}
			...
			final ActionListener buttonsListener = new ActionListener() {
				...
				public void actionPerformed(ActionEvent evt) {
					...
					if (evt.getSource().equals(okBt)) {
						...
						if (selectedId == null
								|| (selectedId != null && selectedId.equals(""))) {

							JOptionPane.showMessageDialog(Editor.getEditor()
									.getParent(), falertMessage, ferrorTitle,
