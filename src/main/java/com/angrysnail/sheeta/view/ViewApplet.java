...
public class ViewApplet extends JApplet {
	...
	/**
	 * the name of the parameter used to specify the uri of the file to be
	 * loaded at startup
	 */
	...
	private void createGUI() {
		...
		try {
			showMenuBar = Boolean.parseBoolean(getParameter(showMenubarParam));
		} catch (Exception ex) {
		}
		...
		regularFrame = (Frame) SwingUtilities.getAncestorOfClass(Frame.class,
				this);
